...
class SereneClient:
    ...
    def download_aida_forecast(
        ...
        The public Python call is ``AIDAState.fromAPI(..., forecast=180)``;
        the HTTP request generated by ``downloadOutput`` sends that value to
        the SERENE forecast endpoint as ``period``.
        """
        if latency not in {"ultra", "rapid", "final"}:
            return False, f"Unsupported AIDA latency: {latency}", None
